<template>
    <div class="px-4 pt-16 mx-auto container">
        <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class="sm:col-span-1">
                <div class="flex items-center space-x-2">
                    <Button variant="default" size="icon">
                        <Icon name="hugeicons:anonymous" class="text-lg" />
                    </Button>
                    <h1 class="text-2xl font-bold">Stack Bhai</h1>
                </div>
            ...
            <div class="space-y-2 text-sm">
                <p class="text-base font-bold tracking-wide text-gray-900">Courses</p>
        ...
        <div class="flex flex-col-reverse justify-between py-5 border-t lg:flex-row">
            <p class="text-sm text-gray-600">
                © Copyright 2026 <span class="font-bold text-muted-foreground">StackBhai</span>. All rights reserved.
            </p>
